...
begin
          ...
          // Работа с Коробами
           ...
           //Работа с KCE, Pony Express, ESP Express, PTK, Credit Consulting
...
//Поле Сопроводительный короб при нажатии кнопки Enter или с помощью сканера Штрих-код.
